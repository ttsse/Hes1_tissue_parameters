...
for i = 1:length(D_d)
    ...
    for j = 1:length(h)
        ...
        for k = 1:length(gamma)
            ...
            % save figures
            path = './Figures';
            filename1 = ['parallel_average_index_' num2str(index) '_D_d_ ' num2str(D_d(i)) '_h_' num2str(h(j)) '_gamma_' num2str(gamma(k)) '.png'];
            filename2 = ['parallel_index_' num2str(index) '_D_d_ ' num2str(D_d(i)) '_h_' num2str(h(j)) '_gamma_' num2str(gamma(k)) '_index_' num2str(index) '.png'];
