...
% System equations correlating to molecules D, P, M, N in that order
F1 = parameters(1) * u(4) - parameters(5) * u(1);
F2 = parameters(3) * u(3) - parameters(7) * u(2);
F3 = parameters(2) * u(1) /(1 + u(2)^parameters(10)) - parameters(6) * u(3);
F4 = parameters(4) / (1 + u(2)^parameters(11)) - parameters(8) * u(4);
s = [F1; F2; F3; F4];
end
